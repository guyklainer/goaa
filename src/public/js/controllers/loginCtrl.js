...
angular.module('App').controller('LoginCtrl', ['$scope', 'blockui', '$http', '$location', 'account', 'socketIO', '$cookies',
    function($scope, blockui, $http, $location, account, $socketIO, $cookies){
